...
interface AnalysisChartsProps {
  analysisData: {
    age: { raw_counts: Record<string, number>; percentages: Record<string, number> };
    children: { raw_counts: Record<string, number>; percentages: Record<string, number> };
    income: { raw_counts: Record<string, number>; percentages: Record<string, number> };
    industry: { raw_counts: Record<string, number>; percentages: Record<string, number> };
    location: { raw_counts: Record<string, number>; percentages: Record<string, number> };
    marital_status: { raw_counts: Record<string, number>; percentages: Record<string, number> };
    political_affiliation: { raw_counts: Record<string, number>; percentages: Record<string, number> };
    property_owner: { raw_counts: Record<string, number>; percentages: Record<string, number> };
    race: { raw_counts: Record<string, number>; percentages: Record<string, number> };
    religion: { raw_counts: Record<string, number>; percentages: Record<string, number> };
    sex: { raw_counts: Record<string, number>; percentages: Record<string, number> };
    sexual_orientation: { raw_counts: Record<string, number>; percentages: Record<string, number> };
  };
}
export default function AnalysisCharts({ analysisData }: AnalysisChartsProps) {
  const refs = {
  ...
  useEffect(() => {
    ...
    // Political Affiliation Pie Chart
    ...
    // Property Ownership Stacked Ratio Bar Chart
